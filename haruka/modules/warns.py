...
def button(bot: Bot, update: Update) -> str:
    ...
    if match:
        ...
        if not is_user_admin(chat, int(user.id)):
            query.answer(text="You are not authorized to remove this warn! Only administrators may remove warns. Powered by @LadySuperstarBOT  Made with ❤️ by @Telegram", show_alert=True)
            return ""
